...
# Dynamic Files
# PATH_TRIPS = "../../"+SCENARIO+"/trips.trips.xml"
# PATH_ROUTES = "../../"+SCENARIO+"/routes.rou.xml"

DEMAND_INTERVAL = 3600/3600

TOD_START= int(float(os.environ.get("TOD_START")))
TOD_END= int(float(os.environ.get("TOD_END")))

# to implement them
# Warm period will depend on how the previous ods effects the current counts
WARM_UP_PERIOD = 2
COOL_DOWN_PERIOD = 0
